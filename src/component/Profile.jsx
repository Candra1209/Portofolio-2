...
function Profile() {
    return (
        <div className='min-h-screen w-full py-32 px-10 sm:px-20 bg-gradient-to-tr from-emerald-950 to-emerald-800'>
            <div className='md:flex justify-center gap-7 lg:gap-14'>
